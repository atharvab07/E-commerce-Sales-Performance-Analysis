...
* Python RFM Segmentation : Customers were successfully grouped into high-value segments (e.g., 'Champions', 'Loyal Customers') based on their Recency, Frequency, and Monetary scores, enabling targeted marketing
  efforts.
* Average Order Value (AOV) : Calculated the overall AOV for the dataset, specifically identifying the AOV of £479.56 for high-performing segments.
